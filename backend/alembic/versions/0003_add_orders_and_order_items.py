...
Create Date: 2026-09-13 00:45:00.000000
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(['product_key_id'], ['product_keys.id'], ),
        sa.ForeignKeyConstraint(['variant_id'], ['product_variants.id'], ),
        sa.PrimaryKeyConstraint('id'),
        sa.UniqueConstraint('product_key_id')
    )
    ...
    op.create_foreign_key('fk_product_keys_order_id', 'product_keys', 'orders', ['order_id'], ['id'])

    # 4. Add composite index ix_product_keys_variant_sold
...
def downgrade() -> None:
    ...
    # 2. Revert product_keys modifications
    op.drop_constraint('fk_product_keys_order_id', 'product_keys', type_='foreignkey')
