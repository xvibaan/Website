...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-[85vh] items-center justify-center relative bg-[#0a0a0c] px-4">
      <ParticleBackground />
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl font-semibold tracking-tight text-white font-sans">Welcome</h2>
