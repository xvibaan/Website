  ...
  const handleLogin = (formData: FormData) => {
    ...
    startTransition(async () => {
      try {
        ...
        setError("SYSTEM ERROR: Failed to authenticate.");
      }
    });
  };
    ...
    <div className="flex min-h-[85vh] items-center justify-center relative">
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-white font-mono uppercase">SYSTEM_LOGIN</h2>
          <p className="mt-2 text-xs text-primary/70 font-mono tracking-widest">ENTER CREDENTIALS TO ACCESS NEXUS</p>
        </div>

        <button onClick={handleGoogleSignIn} className="cyber-btn-outline w-full flex items-center justify-center gap-3 group" type="button">
          <GoogleIcon />
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-[10px] text-primary/50 font-mono tracking-widest">OR MANUAL OVERRIDE</span>
          <div className="flex-1 h-px bg-primary/20" />
        </div>
