...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-[85vh] items-center justify-center px-4 py-12 relative">
      {/* Background orbs */}
      <div className="orb w-80 h-80 bg-secondary/20 top-1/3 right-1/4 animate-float" />
      <div className="orb w-56 h-56 bg-accent/15 bottom-1/3 left-1/4 animate-float-delayed" />
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">Join Host Market Place</p>
        </div>
